...
export const AlldataProvider = ({ children }) => {
    ...
    try {
      ...
      if (!Sensor_status && count == 0) {
        ...
        setTerminalOutput((prev) => [
          ...prev,
          {
            text: `Temperature received at ${sensor_last_Data.Time} - S1:${sensor_last_Data.Sensor1}, S2:${sensor_last_Data.Sensor2}, S3:${sensor_last_Data.Sensor3}`,
            type: "success",
          },
        ]);
      }
  ...
  return (
    <AlldataContext.Provider
      value={{ Sensordata, setData, terminalOutput, setTerminalOutput }}
    >
      {children}
    </AlldataContext.Provider>
  );
