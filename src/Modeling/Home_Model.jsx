...
const Home_Model = () => {
  ...
  return (
    <div className="relative mt-[20%] h-[100%]">
      {/* Background Image */}
      <img src={Images} alt="Background" className="w-full h-[65%] md:h-[85%]" />
      {/* Popup 1 */}
       <div
      ...
      >
        <div className='grid grid-rows-2'>
            <div className='text-[10px] md:text-[18px] flex items-center justify-center 2xl:text-[15px]'>S2</div>
            <div>
      ...
      >
        <div className='grid grid-rows-2'>
            <div className='text-[10px] md:text-[15px] flex items-center justify-center 2xl:text-[15px]'>S3</div>
            <div>
              <div className='flex items-center justify-center '>
                <span><TbTemperaturePlus className='text-[10px] md:text-[15px] 2xl:text-[15px]'/></span>
