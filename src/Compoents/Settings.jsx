    ...
    <div className="w-full h-full flex justify-center items-center">
      <div className="border md:w-[40%] md:h-[90%] rounded-md text-white md:flex">
        <div className="w-[100%] md:w-[100%] h-[50%] md:h-[100%]">
          ...
          <span className="text-[8px]">© 2025 XYMA Analytics Pvt Ltd,IIT Madras Research Park,Chennai,600113</span><br/>
          <span className="text-[6px]">Security: TLS 1.2 protocol</span>
          </div>
